...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray aa = context.obtainStyledAttributes(attrs, R.styleable.TzTabLayout, defStyleAttr, style.Widget_Design_TabLayout);
        ...
        this.mTabLineOffset = aa.getDimensionPixelSize(R.styleable.TzTabLayout_tabLineOffset, 0);
    ...
    public void setupWithViewPager(@NonNull ViewPager viewPager) {
        ...
        if (adapter == null) {
            ...
            if (adapter.getCount() > 0) {
                ...
                if (this.getSelectedTabPosition() != curItem) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mTabMaxWidth != maxTabWidth1) {
...
//                canvas.drawRect((float)this.mIndicatorLeft, (float)(this.getHeight() - this.mSelectedIndicatorHeight), (float)this.mIndicatorRight, (float)this.getHeight(), this.mSelectedIndicatorPaint);
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab) {
            ...
            if (TabLayout.this.mTabBackgroundResId != 0) {
                this.setBackgroundDrawable(getDrawable(context, TabLayout.this.mTabBackgroundResId));
            }
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (measuredWidth < TabLayout.this.mTabMinWidth || measuredWidth > TabLayout.this.mTabMaxWidth) {
                widthMeasureSpec = MeasureSpec.makeMeasureSpec(MathUtils.constrain(measuredWidth, TabLayout.this.mTabMinWidth, TabLayout.this.mTabMaxWidth), MeasureSpec.EXACTLY);
                super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            }
        ...
        final void update() {
            ...
            if (this.mCustomView == null) {
                ...
                if (this.mTextView == null) {
                    TextView textView2 = (TextView) LayoutInflater.from(this.getContext()).inflate(layout.design_layout_tab_text, this, false);
    ...
    public static final class Tab {
        ...
        public Tab setIcon(@DrawableRes int resId) {
            return this.setIcon(getDrawable(this.mParent.getContext(), resId));
        }
